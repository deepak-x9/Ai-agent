const API_BASE_URL = window.QA_API_BASE_URL || "http://localhost:8000";
...
function renderMessage(role, content, languageHint = "") {
  ...
  if (role === "assistant") {
    // Model output is untrusted content: sanitize rendered Markdown before
    // assigning it to the DOM.
...
chatForm.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    errorEl.innerHTML = `<span class="meta">AI Assistant</span>`;
