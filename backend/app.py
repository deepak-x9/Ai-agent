...
# Groq Chat Completions REST API. Keep the key in the environment only; it
# must never be sent to the browser or committed.
...
def request_completion(messages: List[dict]) -> str:
    """Call Groq's Chat Completions endpoint and return the first text answer."""
